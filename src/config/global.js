export default {
  global: {
    componenteFormativo: 'Requerimiento y necesidades en la empresa pecuaria',
    descripcionCurso:
    ...
    imagenBannerPrincipal: require('@/assets/curso/imagenPrincipal.png'),
    fondoBannerPrincipal: require('@/assets/curso/FondoBannerPrincipal.svg'),
  },
  menuPrincipal: {
    menu: [
      {
          ...
          },
          {
            ...
            subMenu: [
              ...
              },
              {
                icono: 'far fa-file-alt',
                numero: '2.3.2',
                titulo: 'Importancia en el ciclo productivo',
                hash: 't_2_3_2',
              },
            ],
          },
